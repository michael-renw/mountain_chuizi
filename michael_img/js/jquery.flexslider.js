  ...
  jQuery.flexslider = function(el, options) {
    ...
    methods = {
      init: function() {
        ...
        if (slider.vars.customDirectionNav !== "") slider.customDirectionNav = jQuery(slider.vars.customDirectionNav).length === 2 && jQuery(slider.vars.customDirectionNav);
          ...
          if(!msGesture){
              slider.slides.on(eventType, function(e){
                ...
                var $slide = jQuery(this),
                    target = $slide.index();
                var posFromLeft = $slide.offset().left - jQuery(slider).scrollLeft(); // Find position of slide relative to left of slider container
                if( posFromLeft <= 0 && $slide.hasClass( namespace + 'active-slide' ) ) {
                  slider.flexAnimate(slider.getTarget("prev"), true);
                } else if (!jQuery(slider.vars.asNavFor).data('flexslider').animating && !$slide.hasClass(namespace + "active-slide")) {
              ...
              slider.slides.each(function (){
                  ...
                  that.addEventListener("MSGestureTap", function (e){
                      ...
                      var $slide = jQuery(this),
                          target = $slide.index();
                      if (!jQuery(slider.vars.asNavFor).data('flexslider').animating && !$slide.hasClass('active')) {
                          slider.direction = (slider.currentItem < target) ? "next" : "prev";
                          slider.flexAnimate(target, slider.vars.pauseOnAction, false, true, true);
                      }
                  });
      ...
      controlNav: {
        ...
        update: function(action, pos) {
          if (slider.pagingCount > 1 && action === "add") {
            slider.controlNavScaffold.append(jQuery('<li><a href="#">' + slider.count + '</a></li>'));
      ...
      directionNav: {
        setup: function() {
          var directionNavScaffold = jQuery('<ul class="' + namespace + 'direction-nav" style="display:none" ><li class="' + namespace + 'nav-prev"><a class="' + namespace + 'prev" href="#">' + slider.vars.prevText + '</a></li><li class="' + namespace + 'nav-next"><a class="' + namespace + 'next" href="#">' + slider.vars.nextText + '</a></li></ul>');
      ...
      pausePlay: {
        setup: function() {
          var pausePlayScaffold = jQuery('<div class="' + namespace + 'pauseplay"><a href="#"></a></div>');
      ...
      sync: function(action) {
        var $obj = jQuery(slider.vars.sync).data("flexslider"),
